    ...
    return keys.length > 0 ? (
        <div className={classes.root}>
            ...
            {keys.map((id) => {
                ...
                /* Regex to match the Bucky timestamp format that is used as the default chat name. 
                The format is: 'Bucky @ MM/DD/YYYY, hh:mm:ss AM/PM'. */
                const autoGeneratedTitleRegex =
                    /Bucky @ [0-9]{1,2}\/[0-9]{1,2}\/[0-9]{1,4}, [0-9]{1,2}:[0-9]{1,2}:[0-9]{1,2} [A,P]M/;
