...
/*
Summary: Tests if Bucky can use the Planner with the Klarna plugin, 
...
export async function klarnaTest(page) {
    ...
    await expect(chatHistoryItems.last()).toHaveAttribute('data-username', 'Bucky');
...
/*
Summary: Tests if Bucky can use the Planner with the Jira plugin, 
...
/*
Summary: Tests if Bucky can use the Planner with the Github plugin, 
